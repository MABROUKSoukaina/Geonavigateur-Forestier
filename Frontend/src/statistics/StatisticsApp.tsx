...
import { T } from './theme';
import {
  fetchGlobalStats, fetchMapGeoJson, fetchFormations, getUsername,
...
export function StatisticsApp({ onLogout }: { onLogout: () => void }) {
  ...
  }, [analyse.ecosysteme, analyse.composition, analyse.strate]);
  ...
  return (
    <div className="ifn-statistics" style={{ height: '100vh', background: T.bg, overflowY: 'auto' }}>
