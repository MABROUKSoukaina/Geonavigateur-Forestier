...
export const HUMUS: Record<number, string> = { 0: "Pas d'humus", 1: 'Humus brut', 2: 'Humus évolué' };
export const AFFLEUREMENT_ROCHEUX: Record<number, string> = { 0: '0 %', 1: '< 10 %', 2: 'Entre 10 % et 30 %', 3: '> 30 %' };
export const CAILLOUX: Record<number, string> = { 0: '< 25 %', 1: '25 % - 50 %', 2: '> 50 %' };
